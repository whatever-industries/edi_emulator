...
//! deviations are marked. Cycle counts are currently coarse placeholders;
//! the datasheet timing pass replaces them before M1 timing work.
...
pub fn execute<B: Bus68k>(cpu: &mut Cpu, bus: &mut B, op: u16) {
    cpu.cycles += 4; // base cost placeholder
    match op >> 12 {
